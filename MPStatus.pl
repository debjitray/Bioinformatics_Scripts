...
# USAGE:: perl MPStatus.pl MP.contigs.sam 101 15000
# This code scans through the sam file and gives them a label based on the FLAGS
# Run after this: perl /data1/users/debray/scripts/ImproperProper.pl MP.contigs.StatusSummary MP_ImproperProper_Sumary.txt 17

my ($insam,$min,$max) = @ARGV;
...
$insam =~ s/\.sam$//;
open OUT, ">$insam.StatusSummary";
print OUT "Read_ID\tChrom\tStart\tStrand\tEnd\tStatus\n";
